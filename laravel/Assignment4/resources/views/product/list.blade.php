      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row mb-2 search-bar">            
            <form class="search-form" type="get" action="{{ url('/product/search') }}">
              <label class="p-2 search-lbl">Keyword</label>
              <input class="search-input mb-2 form-control" name="search-text" type="text" id="search-keyword" />
              <label class="p-2 search-lbl">From :</label>
              <input class="search-input mb-2 form-control" name="from-date" id="dateStart" type="date" />
              <label class="p-2 search-lbl">To :</label>
              <input class="search-input mb-2 form-control" name="to-date" id="dateEnd" type="date" />
              <button class="search-btn btn btn-primary mb-2 " id="search-click">Search</button>
            </form>
          </div>
          <div class="create-bar">
            ...
            <a class="btn btn-primary header-btn" href="/product/download">{{ __('Download') }}</a>
          </div>
